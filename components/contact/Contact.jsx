...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_6qhiheh', 'template_it2d7ts', form.current, {
            publicKey: 'XVAwZPINg_qOt4rKU',
        });
        e.target.reset();
    };
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">(+91) 6399513046</span>
                            <a
                                href="https://api.whatsapp.com/send?phone=6399513046&text=Hi Siddhi, I’d like to discuss a project or opportunity with you!"
