    ...
    <footer className="footer">
      <div className="footer__container container">
        ...
        <div className="footer__social">
          ...
          <a href="https://www.linkedin.com/in/siddhiagrawal0101/" className="footer__social-link" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://leetcode.com/u/agrawalriddhisiddhi8/" className="footer__social-link" target="_blank" rel="noopener noreferrer">
            {/* Option A: Boxicons generic code icon */}
            {/* <i className="bx bx-code-alt"></i> */}

            {/* Option B: Use SVG for LeetCode */}
            <img src="/leetcode.svg" alt="LeetCode" className="footer__leetcode-icon" />
          </a>
        </div>
      </div>
    </footer>
